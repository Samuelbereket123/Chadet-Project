    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col items-center">
            ...
            <div class="mt-8 text-center md:mt-16 md:order-3">
                <a href="https://chadet.org/what-we-do/case-stories.html" target="_blank" title="" class="pb-2 text-base font-bold leading-7 text-gray-900 transition-all duration-200 border-b-2 border-gray-900 hover:border-gray-600 font-pj focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2 hover:text-gray-600"> Check all 5+ reviews </a>
            </div>
                ...
                <div class="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                        ...
                        <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div class="flex-1">
                                ...
                                <blockquote class="flex-1 mt-8">
                                    <p class="text-lg leading-relaxed text-gray-900 font-pj">“Etenesh faced hardship after her parents' divorce, living with her father and later moving to her mother. CHADET intervened, reuniting them, providing financial support, and helping her mother start a bakery. This enabled Etenesh to return to school without financial concerns, changing her life for the better.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div class="flex items-center mt-8">
                                ...
                                <div class="ml-4">
                                    <p class="text-base font-bold text-gray-900 font-pj">Posted By: Etenesh</p>
                                   <p class="mt-0.5 text-sm font-pj text-gray-600">Date of Posting: 21 May 2016</p> 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col overflow-hidden shadow-xl">
                        <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            ...
                            <div class="flex items-center mt-8">
                                <div class="ml-4">
                                    <p class="text-base font-bold text-gray-900 font-pj">Posted by: Tigist Tekele</p>
                                    <p class="mt-0.5 text-sm font-pj text-gray-600">Date of Posting: 21 May 2016</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col overflow-hidden shadow-xl">
                        <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div class="flex-1">
                                ...
                                <blockquote class="flex-1 mt-8">
                                    <p class="text-lg leading-relaxed text-gray-900 font-pj">“
                                        Yemisrach Shimeles, a single mother of two, struggled to provide for her family without education or skills. After joining CHADET’s vocational training in auto body painting, she gained the skills and opportunity to pursue a career, giving her hope for a better future for herself and her children.”</p>
                                </blockquote>
                            </div>

                            <div class="flex items-center mt-8">
                                <div class="ml-4">
                                    <p class="text-base font-bold text-gray-900 font-pj">Posted By: Yemisrach Shimeles
                                    </p>
                                    <p class="mt-0.5 text-sm font-pj text-gray-600">Date of Posting: 21 May 2016</p>
                                </div>
                            </div>
